...
const Zara = ({inventoryItems, handleClose}) => {
    ...
    return (
        <div id="zara-container">
            ...
            {hasRepairTool && (
                <p style={{fontSize: "24px"}}>Use the tool to go fix your ship!!</p>
            )}
            ...
            {repairToolAcquired && (
                <div style={{margin:"60px", display: "flex", flexDirection:"column"}}>
                    <p style={{fontSize: "24px"}}>Zara: I rate your poem as {rating}/5. Congratulations! You've earned the tool to repair your ship. Good luck!</p>
                    </div>
            )} 
            ...
            {challengeFailed && (
                <div style={{margin:"60px", display: "flex", flexDirection:"column"}}>
                    <p style={{fontSize: "24px"}}>Zara: Sorry, but i'd rate your poem as {rating}/5, and that's not good enough. I'd rather listen to the clang of metal. Try again if you think you can improve.</p>
